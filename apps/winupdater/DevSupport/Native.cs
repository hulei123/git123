...
namespace DevSupport
{
    public sealed class NativeMethods
    {
        ...
        { 
            ...
            internal DBT_DEVTYP dbcv_devicetype;
        ...
        { 
            internal uint dbcp_size;
            internal DBT_DEVTYP dbcp_devicetype;
            internal uint dbcp_reserved;
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)]
            internal String dbcp_name = "";
        }
        ...
        internal static extern Boolean HidD_GetPreparsedData(SafeFileHandle HidDeviceObject, out IntPtr PreparsedData);
        ...
        internal const UInt32 CLR_NONE     = 0xFFFFFFFF;
        internal const UInt32 CLR_DEFAULT  = 0xFF000000;
        ...
        internal static extern bool ImageList_GetImageInfo(IntPtr himl, int i, ref IMAGEINFO pImageInfo);

        [DllImport("comctl32.dll", SetLastError = false)]
        internal static extern UInt32 ImageList_GetBkColor(IntPtr himl);

        [DllImport("comctl32.dll", SetLastError = false)]
        internal static extern UInt32 ImageList_SetBkColor(IntPtr himl, UInt32 clrBk);
        ...
        {
            internal Int32 nLength;// = Marshal.SizeOf(typeof(NativeMethods.SECURITY_ATTRIBUTES));
...
//        internal static extern bool CloseHandle(SafeFileHandle hObject);
        ...
        internal static readonly Guid GUID_DEVCLASS_MX_ROM_USB_DEVICE = new Guid("C671678C-82C1-43F3-D700-0049433E9A4B");
...
//            UInt32 Flags);
        ...
        public class SENSE_DATA
        {
            ...
            private NativeMethods.ScsiSenseKey _SenseKey;
            ...
            public void CopyFrom(Byte[] senseBytes)
            {
                ...
                SenseKey = (NativeMethods.ScsiSenseKey)(senseBytes[2] & 0x0F);
            ...
            public NativeMethods.ScsiSenseKey SenseKey { get { return _SenseKey; } set { _SenseKey = value; } }
            ...
            public override string ToString()
            {
                ...
                Utils.EnumConverterEx enumCvtr = new Utils.EnumConverterEx(typeof(NativeMethods.ScsiSenseKey));
